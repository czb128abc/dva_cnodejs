...
class ForceDemo1 extends BaseChart {
    componentDidMount() {
        this.createForce();
    }
    ...
    create() {
        ...
        //  const linear = d3.scaleLinear().domain([0, d3.max(dataset)]).range([0, height - padding.top - padding.bottom]);
        //     const yScale = d3.scaleLinear().domain([0, d3.max(dataset)])
        //         .range([height - padding.top - padding.bottom, 0]);
        //     const yAxis = d3.axisLeft().scale(yScale).ticks(10);
        //     const xScale = d3.scaleBand()
        //         .range([0, width - padding.left - padding.right])
        ...
        const textOffset = rectPadding / 2 + rects.attr('width') / 2
        const texts = svg.append('g')
            .selectAll("g")
            .data(dataset)
            .enter()
            .append("g")
            .attr('width', rects.attr('width'))
            .append('text')
            .attr("x", (d, i) => xScale(i) + textOffset)
            .attr("y", (v) => yScale(v))
            .text((v) => v)
            .attr('transform', `translate(${padding.left}, ${padding.top})`)
    ...
    createForce() {
        ...
        function zoomed() {
            console.log('eeex zoomed', d3.event);
